package com.yunhe.feibinhua.part30.FileDivision;
...
public class fileDivision {
    ...
    public void fileDVS(String fileURL) throws Exception {
        ...
        File Title=new File("D:\\Java_code\\Java_Learn\\src\\com\\yunhe\\FeiBinHua\\part30\\小说\\"+f.getName());
        if(!Title.exists()){
            Title.mkdirs();
        }
//        正则表达式
        ...
        String str="";
        String fileurl="D:\\Java_code\\Java_Learn\\src\\com\\yunhe\\FeiBinHua\\part30\\小说\\五行天[bookben.net].txt\\简介.txt";
        //创建txt文件并写入每章内容
